 ...
 *
 * It handles user inputs, and switches between different panels, the replacement and filter panels
 * 
        ...
        for (int i = 0; i < argsbtnsNumber; i++) {
            switch (i) {
                case 0:
					...
					//button = new JButton(rb.getString ("open"));
                ...
                default:
					...
					//button = new JButton(rb.getString ("button") + i);
